...
import com.ml.catalogg.service.SongsService;
...
public class StatsScreenController implements Initializable {
    ...
    private void setupPickers() {
        ...
        chartTimePicker.setValue(ChartTimeEnum.LAST_WEEK);
    ...
    private void setupCharts() {
        ...
        updateListenedToPieChart(ChartTimeEnum.LAST_WEEK);
        formatPieChart.setLabelsVisible(false);
        formatPieChart.setLegendSide(Side.TOP);
        updateFormatPieChart(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        typePieChart.setLabelsVisible(false);
        typePieChart.setLegendSide(Side.TOP);
        updateTypePieChart(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        ownedPieChart.setLabelsVisible(false);
        ownedPieChart.setLegendSide(Side.TOP);
        updateOwnedPieChart(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        updateListenedLineChart(ChartTimeEnum.LAST_WEEK);
        listenedToLineChart.setLegendVisible(true);
        decadesBarChart.setLegendVisible(false);
        updateDecadesBarChart(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        updateTopArtistsChart(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        artistsBarChart.setLegendVisible(false);
        updateTopGenresChart(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        genresBarChart.setLegendVisible(false);
        updateTopTagsChart(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        tagsBarChart.setLegendVisible(false);
        updateAlbumLengthStats(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        updateSongLengthStats(ChartTimeEnum.LAST_WEEK, DbDataModeEnum.LISTENED);
        }
